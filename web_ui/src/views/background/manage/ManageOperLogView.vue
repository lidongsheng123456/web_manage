  ...
  <div>
    <el-form ref="queryFormRef" :inline="true" :model="queryParams" label-width="70px">
      <el-form-item label="日志标题" prop="title">
        <el-input v-model="queryParams.title" placeholder="请输入日志标题" style="width: 200px" />
      </el-form-item>
      <el-form-item>
    ...
    <el-dialog v-model="dialogOverflowVisible" draggable overflow width="680px" class="log-detail-dialog"
      :style="{ maxWidth: '90vw' }">
      <el-descriptions :column="1" :title="title" border label-width="120px" style="width: 100%">
        ...
        <el-descriptions-item label="方法名称">
          <span class="log-detail-text">{{ from.method }}</span>
        </el-descriptions-item>
        ...
        <el-descriptions-item label="请求URL">
          <span class="log-detail-text">{{ from.operUrl }}</span>
        </el-descriptions-item>
        ...
        <el-descriptions-item label="返回参数">
          <pre class="log-detail-pre">{{ from.jsonResult }}</pre>
        </el-descriptions-item>
        <el-descriptions-item label="操作状态">
          <el-tag v-if="from.status === 0" type="success" size="small">正常</el-tag>
          <el-tag v-else-if="from.status === 1" type="danger" size="small">失败</el-tag>
          <el-tag v-else type="warning" size="small">异常</el-tag>
        </el-descriptions-item>
        <el-descriptions-item label="错误消息">
          <span class="log-detail-text" style="color:#f56c6c">{{ from.errorMsg }}</span>
        </el-descriptions-item>
