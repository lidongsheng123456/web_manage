  ...
  <div>
    <el-form ref="queryFormRef" :inline="true" :model="queryParams" label-width="70px">
      <el-form-item label="名称" prop="name">
        <el-input v-model="queryParams.name" placeholder="请输入名称" style="width: 200px" />
      </el-form-item>
      <el-form-item label="代码" prop="code">
        <el-input v-model="queryParams.code" placeholder="请输入代码" style="width: 200px" />
      </el-form-item>
      <el-form-item>
    ...
    <el-dialog v-model="dialogOverflowVisible" :title="title" draggable overflow width="500">
      <el-form ref="formRef" :inline="true" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="代码" prop="code">
          <el-input v-model="form.code" placeholder="请输入代码" style="width: 350px" />
        </el-form-item>
        <el-form-item label="sql语句" prop="customSql">
          <el-input v-model="form.customSql" placeholder="请输入sql语句" style="width: 350px" type="textarea" />
        </el-form-item>
