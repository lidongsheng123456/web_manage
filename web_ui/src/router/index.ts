...
const routes: RouteRecordRaw[] = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'ManageOnlineView',
                name: 'ManageOnlineView',
                meta: { name: '在线用户' },
                component: () => import('@/views/background/manage/ManageOnlineView.vue')
            },
            {
                path: 'ManageMessageView',
                name: 'ManageMessageView',
                meta: { name: '消息中心' },
                component: () => import('@/views/background/manage/ManageMessageView.vue')
            },
            {
                path: 'ManageFileView',
                name: 'ManageFileView',
            ...
            {
                path: 'ManageTenantView',
                name: 'ManageTenantView',
                meta: { name: '租户管理' },
                component: () => import('@/views/background/manage/ManageTenantView.vue')
            },
            {
